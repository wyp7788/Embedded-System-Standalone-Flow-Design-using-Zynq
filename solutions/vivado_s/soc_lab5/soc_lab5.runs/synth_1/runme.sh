...
HD_PWD='D:/X_Project/X_Workspace/soc_lab3/soc_lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_sys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_sys_wrapper.tcl

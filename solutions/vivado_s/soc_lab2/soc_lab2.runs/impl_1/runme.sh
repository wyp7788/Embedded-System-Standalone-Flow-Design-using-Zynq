...
HD_PWD='D:/X_Project/X_Workspace/soc_lab2/soc_lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_sys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source soc_sys_wrapper.tcl -notrace
